...
public interface UserDao {
	...
	public List<UserEntity> queryWith$(@Param("name") String name) throws SQLException;
	public List<UserEntity> queryWith$2(@Param("tblName") String tblName, @Param("name") String name) throws SQLException;
	public List<UserEntity> queryLikeTwo(@Param("uname") String uname) throws SQLException;
